    ...
    return (
        <div className="bg-white">
            <div className="relative flex justify-center text-center items-center w-full h-[300px] bg-center bg-cover bg-[url('images/agri-bg.jpg')] before:absolute before:z-10 before:w-full before:h-[300px] before:inset-0 before:bg-black/55">
                <h1 className="bg-white absolute text-green-700 bg-opacity-60 z-20 text-4xl max-md:text-3xl  font-bold w-fit  py-2 px-4 mx-auto "><i>MUKSHI AGRI EXPO EVENT</i> </h1>
            </div>
            ...
            <section className="grid grid-cols-2 gap-5 max-lg:grid-cols-1 px-5 py-20 sm:px-20 items-center">
                ...
                <div>
                    <h1 className="text-green-700 text-xl font-semibold">This April in ZAMBIA</h1>
            ...
            <section className="bg-green-700 w-[90vw] h-10 mx-auto">
            <div>
            ...
            <section className="px-5 pb-20 sm:px-20 ">
                <h1 className=" text-4xl max-md:text-3xl font-bold text-black  text-center">
                    Where the <span className="text-green-700 '">MUKSHI AGRI EXPO EVENT</span> will Take Place</h1>
